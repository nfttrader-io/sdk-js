 ...
 */
NFTTraderSDK.prototype.setBlocksNumberConfirmationRequired = function (
 ...
 */
NFTTraderSDK.prototype.createSwap = async function (
  {
    ethMaker,
    taker,
    ethTaker,
  ...
  try {
    let tx = await contract.createSwapIntent(
      swapIntent,
      assetsMaker,
      assetsTaker,
      referralAddress,
 ...
 * @param {string} gasPrice - the gas price of the transaction
 */
NFTTraderSDK.prototype.cancelSwap = async function (
  swapId,
  gasLimit = 2000000,
  gasPrice = null
) {
 ...
 * @param {string} gasPrice - the gas price of the transaction
 */
NFTTraderSDK.prototype.editTaker = async function (
  swapId,
  addressTaker,
  gasLimit = 2000000,
  gasPrice = null
  ...
  try {
    let tx = await contract.editCounterPart(swapId, addressTaker, {
      ...txOverrides,
    })
 ...
 *
 */
NFTTraderSDK.prototype.AssetsArray.prototype.addERC1155Asset = function (
  address,
  tokenIds = [],
  tokenAmounts = []
) {
 ...
 */
NFTTraderSDK.prototype.WebSocketProvider = function ({
  wssUrl,
  network = null,
}) {
 ...
 */
NFTTraderSDK.prototype.WebSocketProvider.prototype.onSwapEvent = function (
  callback,
  { creator = null, time = null, status = null }
) {
 ...
 *
 */
NFTTraderSDK.prototype.WebSocketProvider.prototype.onCounterpartEvent =
  function (callback, { swapId = null, counterpart = null }) {
    if (callback === null || typeof callback === "undefined")
      throw new Error("callback must be provided")
    if (typeof callback !== "function")
      throw new Error("callback must be a Function.")
 ...
 *
 */
NFTTraderSDK.prototype.WebSocketProvider.prototype.onPaymentReceived =
  function (callback, { payer = null }) {
    if (callback === null || typeof callback === "undefined")
      throw new Error("callback must be provided")
    if (typeof callback !== "function")
      throw new Error("callback must be a Function.")
